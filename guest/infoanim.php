    ...
    <div class="container">
        ...
        <table style="color:#f5f5f5; padding-bottom:20px; margin:20px" >
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td 
                    ><a href="infoanimalert.php">Mappa</a></td>
                </tr>
                <tr>
                    <td>Rilis</td>
                    <td>:</td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td 
                    ><a href="infoanimalert.php">Action, <a href="infoanimalert.php">Adventure,</a></a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Link menonton</td>
                    <td>:</td>
                    <td><a href="https://www.bilibili.tv/id/play/37738/379287?bstar_from=bstar-web.pgc-video-detail.episode.all">Klik disini</a></td>
                </tr>
            </table>
        </div>
    </div>
